...
3. Keep functions/modules explicit about inputs, outputs, errors and side effects; prefer `explicit errors` over silent fallback. **Complete when failure behavior is testable.**
