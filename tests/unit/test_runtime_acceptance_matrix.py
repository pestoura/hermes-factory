...
def test_phase_q_accepts_runtime_only_when_all_fifteen_scenarios_pass() -> None:
    evidence_type, matrix_type = _acceptance_contract()
    matrix = matrix_type(candidate_sha="a" * 40)
    evidence = tuple(
        evidence_type(
